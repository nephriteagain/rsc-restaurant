...
export const promos : promoType[] = [
    {
        link: 'cheerybug-chickencheer-christmas-perfect-pairs',
        title: 'Chickencheer Christmas Perfect Pairs',
        desc: `Order 1-pc. Chickencheer, pair it with 1 side, and save as much as P26! Available from November 3-30, 2023 only. Prices Vary.
        ...
        faq: [
            {
                ...
                a: 'Yes, you can upgrade to a Value Meal and add a drink to your order. Drink upgrade is not applicable to 1-pc. Chickencheer w/ Coke Float (for Luzon and Visayas stores) and not applicable for 1-pc. Chickencheer w/ Pepsi Float (for Mindanao stores).'
            },
            {
            ...
            {
                q: 'Can I choose Spicy/New Spicy as my Chickencheer variant?',
                a: 'Yes, you may choose Spicy/New Spicy as the flavor variant of your 1-pc. Chickencheer order, for an additional P5 per piece. '
            },
            {
    ...
    },
    {
        ...
        Get FREE 1-pc. Chickencheer Solo (min. order of 350) or Peach Mango Pie 3 Pies To-Go (min. order of P450) on your first delivery order! Promo runs from Nov 3 – 31, 2023.
        ...
        faq: [
            ...
            },
            {
                ...
                3) Redeem the coupon: FREE 1-pc. Chickencheer Solo or Peach Mango Pie 3 Pies To-Go
