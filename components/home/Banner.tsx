...
export default function Banner() {
    return (
        <div className="relative w-full h-fit overflow-hidden flex flex-col items-center text-white">
            <div className="scale-75 sm:scale-100 min-w-[300px] max-w-[400px] absolute-center sm:left-12 sm:top-12 sm:translate-x-0 sm:translate-y-0 flex flex-col gap-6">
