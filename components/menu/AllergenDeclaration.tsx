        ...
        <div className="flex flex-col gap-2">
            ...
            </div>
            {
                ...
                <div className="flex flex-col gap-4 p-8 text-base bg-white shadow-lg drop-hadow-lg rounded-3xl animate-flip-down">
                    ...
                    <p>
                        The allergen information in this document is intended to serve as a general guide only and is not intended to provide any legal or medical advice. Such medical or legal advice relevance to a customers circumstances should be obtained separately by such customers. Cheerybug, its directors, employees, subsidiaries and franchisees expressly disclaim liability for any loss, costs, or damage suffered or incurred by users relying on this document.
                    </p>
                    <p>
